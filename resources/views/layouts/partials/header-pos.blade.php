...
<div class="col-md-12 no-print pos-header">
    ...
    <div
        ...
        <div class="tw-w-full md:tw-w-2/3 !tw-p-0 tw-flex tw-items-center tw-justify-between tw-gap-4 tw-flex-col md:tw-flex-row tw-hidden md:tw-flex"
           ...
           <!--   <a href="{{ $go_back_url }}" title="{{ __('lang_v1.go_back') }}"
              ...
              <strong class="!tw-m-3">
                    <i class="fa fa-backward fa-lg fa fa-home tw-fa-lg tw-text-[#009EE4] !tw-text-sm"></i>
                ...
                <strong class="!tw-m-3 tw-flex tw-flex-col tw-items-center">
                     <i class="fa fa-backward fa-lg fa fa-home tw-fa-lg tw-text-[#009EE4] !tw-text-sm"></i>
                    <span>Home</span>
                </strong>
            ...
            <!--        <strong class="!tw-m-3">
                    ...
                    <strong class="!tw-m-3 tw-flex tw-flex-col tw-items-center">
    <i class="fa fa-backward fa-lg fa fa-window-close tw-fa-lg tw-text-[#EF4B53] !tw-text-sm"></i>
    <span>Close Register</span>
            ...
            @can('view_cash_register')
                <button type="button" id="register_details" title="{{ __('cash_register.register_details') }}"
                class=" m-5 btn-modal pull-right"
   ...
   <!--           <strong class="!tw-m-3">
                    ...
                    <strong class="!tw-m-3 tw-flex tw-flex-col tw-items-center">
    <i class="fa fa-backward fa-lg fa fa-briefcase tw-fa-lg tw-text-[#00935F] !tw-text-sm"></i>
    <span >Register</span>
</strong> 
         ...
         <!--       <strong class="!tw-m-3">
                ...
                <strong class="!tw-m-3 tw-flex tw-flex-col tw-items-center">
    <i class="fa fa-backward fa-lg fa fa-calculator tw-fa-lg tw-text-[#EF4B53] !tw-text-sm"></i>
    <span>Calc</span>
</strong>
            ...
            <button type="button"
                ...
                id="return_sale" title="@lang('lang_v1.sell_return')" data-trigger="click"
                data-content='<div class="m-8"><input type="text" class="form-control" placeholder="@lang('sale.pos_sale_return')" id="send_for_sell_return_invoice_no"></div><div class="w-100 text-center"><button type="button" class="tw-dw-btn tw-dw-btn-error tw-text-white tw-dw-btn-sm" id="send_for_sell_return">@lang('lang_v1.send')</button></div>'
                data-html="true" data-placement="bottom">
          <!--      <strong class="!tw-m-3">
                ...
                <strong class="!tw-m-3 tw-flex tw-flex-col tw-items-center">
    <i class="fa fa-backward fa-lg fa fa-undo tw-fa-lg tw-text-[#EF4B53] !tw-text-sm"></i>
