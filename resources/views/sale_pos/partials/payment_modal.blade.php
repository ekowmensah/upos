    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content rounded=5">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="box box-solid bg-orange-400" style="border: 2px solid orange; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3);">
                            <div class="box-body">
                                <div class="col-md-12">
                                    <strong>
            ...
            <div class="modal-footer">
                <button type="button" class="tw-dw-btn tw-dw-btn-neutral tw-text-white" data-dismiss="modal">@lang('messages.closepayment')</button>
...
.modal-body {
    overflow-y: auto;
    max-height: calc(100vh - 200px); /* Adjust height as necessary */
    padding-bottom: 60px; /* Adjust this to ensure content does not overlap the footer */
}
</style>