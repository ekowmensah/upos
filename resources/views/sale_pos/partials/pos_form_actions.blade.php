                ...
                @if (!$is_mobile)
                    ...
                    <div class="pos-total md:tw-flex md:tw-items-center md:tw-gap-3 tw-hidden">
                     ...
                     <!--       <div>Total</div> -->
                        ...
                        <input type="hidden" name="final_total" id="final_total_input" value="0.00">
                        <span class="number" id="total_payable" style="color: #14532d; font-weight: bold; font-size: 30px;">0.00</span>
                    </div>
                @endif
 
 <span class="curr_datetime" id="vintageClock"></span>
            </div>
...
#vintageClock {
    ...
    font-size: 26px;
    letter-spacing: 1px;
    color: #483C32; /* Antique dark brown */
    text-shadow: 2px 2px 4px #000000; /* Shadow for depth */
}

/* Hide the clock on screens smaller than 768px (e.g., typical mobile devices) */
...
<script>
    function updateTime() {
        ...
        document.getElementById('vintageClock').textContent = formattedTime;
    }
