...
return [
    ...
    'purchase_already_exist' => "Product can't be deleted because purchases related to 
								this product exist",
    'sale_already_exist' => "Product can't be deleted because sale related to this product exist",
    ...
    'layout_credit_note' => 'Credit Note / Sale Return Details',
    'cn_heading' => 'Heading',
    ...
    'view_own_sell_only' => 'View own sale(s) only',
    ...
    'converted' => 'Converted',
    'view_commission_agent_sell' => 'Commission agent can view their own sales',
    ...
    'view_all_sale' => 'View all Sales',
    'view_paid_sells_only' => 'View paid sales only',
    'view_due_sells_only' => 'View due saless only',
    'view_partially_paid_sells_only' => 'View partially paid sales only',
    'view_overdue_sells_only' => 'View overdue sales only',
    'customer_with_no_sell_one_month' => 'View customers with no sale from one month only',
    'customer_with_no_sell_three_month' => 'View customers with no sale from three months only',
    'customer_with_no_sell_six_month' => 'View customers with no sale from six months only',
    'customer_with_no_sell_one_year' => 'View customers with no sale from one year only',
    'customer_permissions_tooltip' => 'To view all customers with no sale from a specific time <b>View all customer</b> permission is required otherwise it will filter with only cusromers created by the logged in user',
    'sell_permissions_tooltip' => 'To view sales on the basis of payment status <b> View all sales</b> permission is required otherwise it will filter with only sells created by the logged in user',
    'access_pending_shipments_only' => 'Access pending shipments only',
    'access_all_sell_return' => 'Access all sale return',
    'access_own_sell_return' => 'Access own sale return',
    ...
    'add_sell_payment' => 'Add sale payment',
    ...
    'customer_irrespective_of_sell' => 'View customers irrespective of their sale',
    ...
    'has_no_sell_from' => 'Has no sale from',
    'one_month' => 'One month',
    ...
    'new_sale_notification_help' => 'If enabled, sale notification will be automatically sent to customer on creating new sales for them',
    ...
    'change_return_payment_method' => 'Change(x) Method',
    'change_return_payment_account' => 'Change(x) Account',
    ...
    'secondary_unit_help' => 'Allows user to enter product quantity in secondary unit during purchase/sale',
